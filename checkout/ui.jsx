...
const CO_ICONS = {
  ...
  cashapp: <><rect x="3.5" y="3.5" width="17" height="17" rx="5" /><path d="M14.4 9.4a3.1 3.1 0 0 0-2.6-1.3c-1.4 0-2.4.8-2.4 1.9 0 2.5 5.3 1.4 5.3 3.9 0 1.2-1.1 2-2.6 2a3.1 3.1 0 0 1-2.6-1.3M12 6.6v1.5M12 15.9v1.5" /></>,
  venmo:   <><rect x="3.5" y="3.5" width="17" height="17" rx="5" /><path d="M8.4 7.8c.5 1.4.8 3 .8 4.6 0 .9-.1 1.7-.3 2.4h2.7c1.6-2 3-4.5 3-6.6 0-1-.3-1.7-.8-2.2" /></>,
